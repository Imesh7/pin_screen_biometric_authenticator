...
import 'src/method_channel/check_biometric.dart';
import 'src/widgets/icon_pin_circle.dart';
import 'src/widgets/null_pin_circle.dart';
import 'src/widgets/pin_circle.dart';
import 'src/widgets/pin_textfield.dart';

typedef AuthResultCallBack = void Function(bool? result);

class PinInptBiometricAuthenticator extends StatefulWidget {
  ...
  const PinInptBiometricAuthenticator(
      {super.key,
  ...
  @override
  State<PinInptBiometricAuthenticator> createState() =>
      _PinInptBiometricAuthenticatorState();
}

class _PinInptBiometricAuthenticatorState
    extends State<PinInptBiometricAuthenticator> {
