...
class MethodChannelBiometricAutheticator
    extends BiometricAuthenticatorPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel =
      const MethodChannel('pin_input_biometric_authenticator');

  @visibleForTesting
  final eventChannel =
      const EventChannel('pin_input_biometric_authenticator_event');
